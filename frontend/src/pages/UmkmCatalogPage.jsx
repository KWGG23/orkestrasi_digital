...
export default function UmkmCatalogPage() {
  ...
  return (
    <PortalLayout crumbs={[{ label: 'Katalog UMKM' }]}>
      <Seo
        title="Katalog UMKM"
        description="Katalog usaha mikro, kecil, dan menengah di Dusun Karangasem & Blongkeng — kuliner, kerajinan, pertanian, jasa, dan perdagangan, lengkap dengan kontak WhatsApp."
      />
